...
> **学习导航**　前置：第 10–25 章的实时系统、OMS、风控、回放、仿真校准与研究｜目标：定义 failure model、SLO、持久化、部署、安全和恢复 gate｜预计：16–22 小时｜产出：runbook、容量曲线、故障演练和恢复审批记录

## 26.1 先写 Failure Model
...
*-1：恢复软件服务不等于恢复交易权限；对账、根因隔离和 canary gate 缺一不可。*
